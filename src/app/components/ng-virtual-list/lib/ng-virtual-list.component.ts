...
import {
  ...
  DEFAULT_SCREEN_READER_MESSAGE, BEHAVIOR_SMOOTH,
} from './const';
import {
      ...
      switchMap(([,
        ...
        if (container) {
          ...
          const { width, height } = bounds,
            scrollLength = (this._isVertical ? this._container()?.nativeElement.scrollHeight ?? 0 : this._container()?.nativeElement.scrollWidth) ?? 0,
